...
// AES-encrypted + Base64 payload (you can change this)
...
app.post("/", (req, res) => {
  ...
  // Block if no timezone or not from Asia/Tokyo
  if (!timezone || timezone !== "Asia/Tokyo") {
    console.log("Blocked non-Japan request:", timezone, fullUrl);
    return res.status(403).send("Forbidden");
  }

  // Allow only Asia/Tokyo timezone
  console.log("✅ Japan request allowed:", timezone, fullUrl);
